...
class HomeScreenTimelineTimelineFragment extends StatefulWidget {
  const HomeScreenTimelineTimelineFragment({super.key});

  @override
  State<HomeScreenTimelineTimelineFragment> createState() => _HomeScreenTimelineTimelineFragmentState();
}

class _HomeScreenTimelineTimelineFragmentState extends State<HomeScreenTimelineTimelineFragment> {
  @override
